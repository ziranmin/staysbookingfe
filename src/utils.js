...
//const domain = "";
const domain = "https://mzrstaybooking.uc.r.appspot.com";
...
export const searchStays = (query) => {
  ...
  searchStaysUrl.searchParams.append("destination", query.destination);
  ...
  // searchStaysUrl.searchParams.append("lat", 41.49);
  // searchStaysUrl.searchParams.append("lon", -71.24);
